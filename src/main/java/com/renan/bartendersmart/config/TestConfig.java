...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido p1 = new Pedido(null, Instant.parse("2019-06-20T19:53:07Z"),PedidoStatus.WAITING_PRODUCTION, m1);
		Pedido p2 = new Pedido(null, Instant.parse("2019-07-21T03:42:10Z"),PedidoStatus.READY, m2);
		Pedido p3 = new Pedido(null, Instant.parse("2019-07-22T15:21:22Z"),PedidoStatus.DELIVERED, m1); 
